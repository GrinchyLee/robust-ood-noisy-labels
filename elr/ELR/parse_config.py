...
class ConfigParser:
    ...
    def __init__(self, args, options='', timestamp=True):
        ...
        self._save_dir = save_dir / 'models' / exper_name / f"{self.config['trainer']['epochs']}_beta_{self.config['train_loss']['args']['beta']}_lambda_{self.config['train_loss']['args']['lambda']}_{self.config['seed']}"
        self._log_dir = save_dir / 'log' / exper_name / f"{self.config['trainer']['epochs']}_beta_{self.config['train_loss']['args']['beta']}_lambda_{self.config['train_loss']['args']['lambda']}_{self.config['seed']}"
