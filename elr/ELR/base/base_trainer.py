...
class BaseTrainer:
    ...
    def _save_checkpoint(self, epoch, save_best=False):
        ...
        # last model
        every_epoch_path = str(self.checkpoint_dir / 'last_model.pth')
        torch.save(state,every_epoch_path)
        ...
        if epoch == 150:
            ...
            epoch150_path = self.checkpoint_dir / 'epoch_150_best.pth'
            shutil.copyfile(best_model_path, epoch150_path)
        if epoch == 200:
            best_model_path = self.checkpoint_dir / 'model_best.pth'
            epoch200_path = self.checkpoint_dir / 'epoch_200_best.pth'
            shutil.copyfile(best_model_path, epoch200_path)
