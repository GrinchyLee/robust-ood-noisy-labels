...
def main(config: ConfigParser):
    ...
    model1 = ResNet18_32x32(num_classes=config['arch']['args']['num_classes'])
    model_ema1 = ResNet18_32x32(num_classes=config['arch']['args']['num_classes'])
    model_ema1_copy = ResNet18_32x32(num_classes=config['arch']['args']['num_classes'])
    model2 = ResNet18_32x32(num_classes=config['arch']['args']['num_classes'])
    model_ema2 = ResNet18_32x32(num_classes=config['arch']['args']['num_classes'])
    model_ema2_copy = ResNet18_32x32(num_classes=config['arch']['args']['num_classes'])
