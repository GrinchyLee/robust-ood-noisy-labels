...
class ConfigParser:
    ...
    def __init__(self, args, options='', timestamp=True):
        ...
        self._save_dir = save_dir / 'models' / exper_name / f"{self.config['trainer']['epochs']}_lru_{self.config['lr_u']}_lrv_{self.config['lr_v']}_{self.config['seed']}"
        self._log_dir = save_dir / 'log' / exper_name / f"{self.config['trainer']['epochs']}_lru_{self.config['lr_u']}_lrv_{self.config['lr_v']}_{self.config['seed']}"
