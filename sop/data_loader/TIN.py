...
class Tinyimagenet_train(Dataset):
    def __init__(self, txt_file, root, cfg_trainer, transform=None, transform_aug=None):
        self.root = root
        ...
        if self.cfg_trainer.get("noise_file"):
            ...
            for i in range(len(self.image_paths)):
                rel_path = os.path.relpath(self.image_paths[i], self.root)  
    ...
    def __getitem__(self, index):
        ...
        img2 = self.transform_aug(img) if self.transform_aug else None
...
class Tinyimagenet_val(Dataset):
    def __init__(self, txt_file, root, cfg_trainer, transform=None):
        self.root = root
        self.cfg_trainer = cfg_trainer
        self.transform = transform
        self.num_classes = 200
