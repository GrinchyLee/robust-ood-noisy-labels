...
def get_network(network_config):
    ...
    elif network_config.name == 'resnet18_128x128':
        net = ResNet18_128x128(num_classes=num_classes)
    ...
    elif network_config.name == 'preactresnet18_32x32':
        net = preactresnet18_32x32(num_classes=num_classes)
