...
DATA_INFO = {
    ...
    'cifar20': {
        ...
        'id': {
            'train': {
                'data_dir': 'images_classic/',
                'imglist_path': 'benchmark_imglist/cifar100/train_cifar100_coarse.txt'
            },
            'val': {
                'data_dir': 'images_classic/',
                'imglist_path': 'benchmark_imglist/cifar100/val_cifar100_coarse.txt'
            },
            'test': {
                'data_dir': 'images_classic/',
                'imglist_path': 'benchmark_imglist/cifar100/test_cifar100_coarse.txt'
            }
        },
        'csid': {
            'datasets': [],
    ...
    'tinyimagenet': {
        ...
        'id': {
            'train': {
                'data_dir':'images_classic/',
                'imglist_path':'benchmark_imglist/tinyimagenet/train_tin.txt'
            },
            'val': {
                'data_dir': 'images_classic/',
                'imglist_path':
                'benchmark_imglist/tinyimagenet/val_tin.txt'
            },
            'test': {
                'data_dir':
                'images_classic/',
                'imglist_path':
                'benchmark_imglist/tinyimagenet/test_tin.txt'
            }
        },
        'csid': {
            'datasets': ['imagenet_v2', 'imagenet_c', 'imagenet_r'],
        ...
        'ood': {
            'val': {
                'data_dir': 'images_largescale/',
                'imglist_path':
                'benchmark_imglist/tinyimagenet/val_openimage_o.txt'
            },
            'near': {
                'datasets': ['ssb_hard', 'ninco'],
                'ssb_hard': {
                    ...
                    'images_largescale/',
                    'imglist_path':
                    'benchmark_imglist/tinyimagenet/test_ssb_hard.txt'
                },
                'ninco': {
                    'data_dir': 'images_largescale/',
                    'imglist_path':
                    'benchmark_imglist/tinyimagenet/test_ninco.txt'
                }
            },
            'far': {
                'datasets': ['inaturalist', 'textures', 'openimage_o'],
                'inaturalist': {
                    ...
                    'images_largescale/',
                    'imglist_path':
                    'benchmark_imglist/tinyimagenet/test_inaturalist.txt'
                },
                'textures': {
                    'data_dir':
                    'images_classic/',
                    'imglist_path':
                    'benchmark_imglist/tinyimagenet/test_textures.txt'
                },
                'openimage_o': {
                    'data_dir':
                    'images_largescale/',
                    'imglist_path':
                    'benchmark_imglist/tinyimagenet/test_openimage_o.txt'
                },
            },
        }
    },
...
download_id_dict = {
    ...
    # 'cifar20' : '1PGKheHUsf29leJPPGuXqzLBMwl8qMF8_',
...
dir_dict = {
    'images_classic/': [
        ...
        'fractals_and_fvis', 'usps', 'texture', 'notmnist'#,'cifar20'
    ],
    'images_largescale/': [
        'imagenet_1k',
        'ssb_hard',
...
benchmarks_dict = {
    ...
    'cifar20':
    ['cifar20','cifar10', 'tin', 'mnist', 'svhn', 'texture', 'places365'],
    'imagenet200': [
