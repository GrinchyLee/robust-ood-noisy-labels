...
python main.py \
    ...
    --network.checkpoint "../promix/save/seed0/no_mixup_v2_entropyy0.01_cifar100_noisy_label_0_0.5,0.5_300_epoch_300_model_net1.pth.tar" \
    --seed 0
...
python main.py \
    ...
    --network.backbone.checkpoint ../promix/save/seed0/no_mixup_v2_entropyy0.01_cifar100_noisy_label_0_0.5,0.5_300_epoch_300_model_net1.pth.tar \
    --seed 0
