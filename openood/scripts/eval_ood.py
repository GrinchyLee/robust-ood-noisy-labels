...
from openood.networks import ResNet18_32x32, ResNet18_224x224, ResNet50, ResNet18_128x128,ResNet18_64x64
...
parser.add_argument(
    ...
    type=str,
    default='cifar10',
    choices=['cifar10', 'cifar100', 'aircraft', 'cub', 'imagenet200','cifar20','tinyimagenet'])
...
NUM_CLASSES = {'cifar10': 10, 'cifar100': 100, 'imagenet200': 200,'cifar20':20,'tinyimagenet':200}
MODEL = {
    'cifar10': ResNet18_32x32,
    'cifar100': ResNet18_32x32,
    'cifar20': ResNet18_32x32,
    'imagenet200': ResNet18_128x128,
    'tinyimagenet':ResNet18_64x64,
}
