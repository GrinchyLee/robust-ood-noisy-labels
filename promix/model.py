...
class DualNet(nn.Module):
    def __init__(self, num_class):
        ...
        self.net1 = ResNet18_32x32(num_classes=num_class)
        self.net2 = ResNet18_32x32(num_classes=num_class)
...
class DualNet_TIN(nn.Module):
    def __init__(self, num_class):
        super().__init__()
        # self.net1 = ResNet18(num_classes=num_class)
        # self.net2 = ResNet18(num_classes=num_class)
        self.net1 = ResNet18_64x64(num_classes=num_class)
        self.net2 = ResNet18_64x64(num_classes=num_class)
