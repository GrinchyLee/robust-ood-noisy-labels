...
for epoch in range(args.num_epochs + 1):
    ...
    torch.save(dualnet,f"save/seed{args.seed}/yes_mixup_energy0.001_{args.dataset}_{args.noise_type}_{args.seed}_{args.rho_range}_{args.num_epochs}.pth.tar")
